...
function load_fund_special_rate_summary(gv_cbgroup, gv_product, gv_valuta, div_graph){
	draw_special_rate(gv_cbgroup, gv_product, gv_valuta, div_graph);
...
function load_fund_summary(gv_cbgroup, gv_product, gv_valuta){	
    load_fund_special_rate_summary(gv_cbgroup, gv_product, gv_valuta, "chartdiv_special_rate");
}