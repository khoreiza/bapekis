...
function draw_pipeline_graph(v_data, v_id_div, v_id_div_highlight){
	...
	*/
	// Draw Highlight
	percentage = parseFloat((total_realization+3495566000000+120000000000+601000+12585000000000-15381000000000)*100 / total_target).toFixed(get_bhd_comma(total_realization+3495566000000+120000000000+601000+12585000000000-15381000000000*100 / total_target));
	...
	var chart = AmCharts.makeChart("chartdiv_pipeline", {
		...
		"theme": "light",
		  "dataProvider": [ {
			...
			"close": total_realization+0,//3495566000000,
...
function draw_table_rincian(v_detail_type, v_data, v_id_table_rincian){
	...
	*/
	...
	$.each( v_data.targets, function( key, valTarget ) {
		...
		tol_all_cb = realization+3495566000000+120000000000+601000+12585000000000-15381000000000;
		items.push("<tr>"+
		...
		"<td>"+get_show_number(3495566000000).toFixed(get_bhd_comma_val(get_show_number(3495566000000)))+" "+get_show_number_satuan(3495566000000)+"</td>"+
		"<td>"+get_show_number(120000000000).toFixed(get_bhd_comma_val(get_show_number(120000000000)))+" "+get_show_number_satuan(120000000000)+"</td>"+
		"<td></td>"+
		"<td></td>"+
		"<td></td>"+
		"<td></td>"+
		"<td>"+get_show_number(-15381000000000).toFixed(get_bhd_comma_val(get_show_number(-15381000000000)))+" "+get_show_number_satuan(-15381000000000)+"</td>"+
		"<td>-</td>"+
...
function load_credit_pipeline_summary(gv_cbgroup, gv_product, gv_valuta){	
