 ...
 */
(function($){$.fn.lightBox=function(settings){settings=jQuery.extend({maxWidth: null,maxHeight: null,overlayBgColor:'#000',overlayOpacity:0.8,fixedNavigation:false,imageLoading:config.base+'assets/css/images/lightbox-ico-loading.gif',imageBtnPrev:config.base+'assets/css/images/lightbox-btn-prev.gif',imageBtnNext:config.base+'assets/css/images/lightbox-btn-next.gif',imageBtnClose:config.base+'assets/css/images/lightbox-btn-close.gif',imageBlank:config.base+'assets/css/images/lightbox-blank.gif',containerBorderSize:10,containerResizeSpeed:400,txtImage:'Image',txtOf:'of',keyToClose:'c',keyToPrev:'p',keyToNext:'n',imageArray:[],activeImage:0},settings);var jQueryMatchedObj=this;function _initialize(){_start(this,jQueryMatchedObj);return false;}
