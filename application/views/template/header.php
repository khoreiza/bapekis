<style type="text/css">
    ...
    @media (min-width: 800px) {
        ...
        .broventh_left_content{
            padding-right: 20px;
        }
        .broventh_right_content{
            padding-left: 20px;
        }
    }
    ...
    .square_box{
        ...
        padding: 0px;
        margin-bottom: 10px;
        border-top: 3px solid <?=array_color_new(3)?>;
        /*overflow: auto;*/
    }
    ...
    .total_tr td{
        border-color: <?=array_color_new(3)?> !important;
    }
    /********** Profile Menu Tab ************/
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8 col-sm-8 col-xs-12 lh">
                <p>Welcome to Mandiri Bapekis Website
                </p>
            </div>
