    ...
    <div class="shadow-main">
        <div id="col-side" class="login-form animated fadeIn">		
			<div id="loginContainer" style="width: 400px; margin:0 auto; padding-top: 170px; margin-bottom: 300px">
				<form id="loginForm" role="form" action="<?php echo base_url();?>account/login_action" method="post" style="background-color:#e2e2e2; padding:30px; border-radius: 20px; opacity:0.8">
